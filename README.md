...
### 💬 [Slouch](https://github.com/nicogarbaccio/slouch) // A single-page, lightweight version of the messaging app Slack
...
### 🏫 [ExplorED](https://github.com/nicogarbaccio/explored) // An e-learning app that lets instructors and students share materials, create discussions, and more
...
### 🎶 [Groovehound](https://github.com/nicogarbaccio/groovehound) // A concert tracker that lets users find upcoming concerts and keep track of the ones they've been to
